...
const DeleteGameFromWishListButton: FC<Props> = ({ gameData, fetchUserDetails }) => {
  ...
  const confirmDeleteGame = async () => {
    try {
      const response = await fetch(
        `https://clicker-critics-api.onrender.com/wishlist/remove_game/${gameData.id}`,
        {
          method: "DELETE",
          headers: {
...
export default DeleteGameFromWishListButton;
