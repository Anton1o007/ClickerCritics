...
import { Critic } from "@/models/Critic/types";
import Link from "next/link";
import DeleteCriticButton from "../DeleteCriticButton";
...
const CriticCard: FC<Props> = ({ criticData, fetchData, checkReview }) => {
    ...
    <Container>
      <Box>
        ...
        <ButtonsRow>
          ...
          {localStorage.getItem("user_id") === criticData.userId && (
            <DeleteButtonContainer>
              <DeleteCriticButton
