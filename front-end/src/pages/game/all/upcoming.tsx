...
const UpcomingGames = () => {
  const defaultUrl = "https://clicker-critics-api.onrender.com/game/games_list?upcoming=true";
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (gamesData) {
        const normalizedGamesList = gamesData.map((gameScoreTuple: any) => {
